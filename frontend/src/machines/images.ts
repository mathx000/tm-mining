...
export const machineImages = {
  ...
  'Britadeira de maxilas Metso Nordberg C125': metsoC125Img,
  'Britadeira de maxilas Parker 36X24': parkerImg,
  'Britadeira de maxilas Sany SANYO 1050 x 750': sanyImg,
  'Britador de cone Metso HP200': metsoHp200Img,
  'Britador de cone Sandvik CH430': sandvikCh430Img,
  'Britador de cone Sandvik cs 430': sandvikCs430Img,
  'Escavadora de rastos Komatsu PC600': komatsuImg,
  'Mini-escavadora Kubota KX057-4': kubotaImg,
  'Mini-escavadora Yammer Vio 55': yanmarImg,
  'Trituradora de rotor Metso BARMAC B6150SE VSI': metsoBarmaB6Img
};
