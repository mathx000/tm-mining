...
export const Contato: React.FC = () => {
  return (
    <section
      id="contacto"
      className="bg-[#1a1a1a] px-6 py-20 text-white lg:px-8"
    >
      <div className="mx-auto max-w-7xl">
        <div>
          ...
          <div className="mt-8 space-y-4 text-sm text-gray-300">
            ...
            <a
              href="https://wa.me/351933852559?text=Ol%C3%A1%2C%20estou%20interessado%20nos%20equipamentos%20TM%20Mining%20Internacional."
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center gap-2 rounded-full bg-[#25D366] px-4 py-2 font-semibold text-white transition hover:bg-[#1ebe5b]"
            >
              <svg
